This project was bootstrapped with [Create React Native App](https://github.com/react-community/create-react-native-app) to demonstrate how to use the Pumpup APIs with React Native.

##### After the app launches and loads the data
![Screensot](./README-pics/initial_screen.png)

##### When the Read More button is pressed
![Screensot](./README-pics/with_readmore.png)
